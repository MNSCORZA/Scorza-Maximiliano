                ...
                <td className="p-6">
                  <div className="flex justify-center gap-2">
                    ...
                    {u.id !== currentUser?.uid && (
                      <button onClick={() => onDelete(u.id)} className="p-3 bg-red-50 text-red-600 rounded-xl hover:bg-red-600 hover:text-white transition-all shadow-sm">
                        <Trash2 size={16} />
                      </button>
                    )}
                  </div>
          ...
          <div key={u.id} className="p-6 bg-white space-y-6">
            <div className="flex justify-between items-start">
              ...
              <div className="flex gap-2">
                ...
                {u.id !== currentUser?.uid && (
                  <button onClick={() => onDelete(u.id)} className="p-3 bg-gray-50 text-red-400 rounded-xl active:bg-red-600 active:text-white transition-all">
                    <Trash2 size={18} />
                  </button>
                )}
              </div>
