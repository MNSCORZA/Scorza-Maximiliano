  ...
  <div className={colSpan}>
    ...
    <div className="relative">
      ...
      <input 
        ...
        className="w-full bg-slate-50 border-2 border-transparent rounded-xl py-2.5 pl-9 pr-3 text-sm font-bold text-slate-700 outline-none focus:bg-white focus:border-indigo-600/20 transition-all disabled:opacity-60 text-ellipsis"
      />
    </div>
  </div>
));
