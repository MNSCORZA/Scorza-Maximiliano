  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8 flex justify-center items-center">
      <form onSubmit={handleFinalizarCompra} className="bg-white p-10 rounded-[2.5rem] shadow-2xl max-w-lg w-full space-y-6">
        <h2 className="text-3xl font-black text-center text-gray-900">Finalizar Compra</h2>
        ...
        <input name="email" value={formData.email} onChange={handleChange} placeholder="Email" className="w-full bg-gray-50 rounded-2xl py-4 px-5 font-bold outline-none border-2 border-transparent focus:border-indigo-600/20" required />
        ...
        <button disabled={loading} className="w-full bg-gray-900 text-white font-black uppercase py-5 rounded-2xl shadow-xl hover:bg-indigo-600">
